    ...
    <div id="demo" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner"  style="max-height:500px;">
            <div class="carousel-item active">
                <img src="<?php echo base_url(). 'assets/images/1.jpg'?>" alt="Los Angeles">
            </div>
            <div class="carousel-item">
                <img src="<?php echo base_url(). 'assets/images/banner2.jpg'?>" alt="Los Angeles">
            </div>
            <div class="carousel-item">
                <img src="<?php echo base_url(). 'assets/images/banner3.jpg'?>" alt="Los Angeles">
            </div>
        </div>
...
<div class="products">
    <div class="container">
        <div class="banner-bottom-grids">
            ...
            <div class="col-md-4 bottom-grid">
                <img src="<?php echo base_url() . 'assets/images/Mountains/2.jpg';?>" style="max-height:400px;"
                    alt="" />
                <div class="bottom-grid-info">
...
<div class="products-bottom">
    ...
    <div class="container">
        <div class="col-md-12">
            <h3 style="color:#f45a40; font-size:23px; font-weight: 600;">About <span style="color: dimgray">The
                    Artist</span></h3>
            <p
                style="color:#777;font-size: 18px;text-align:justify;margin:2em 0;font-family: 'Roboto Condensed', sans-serif;">
                <span style="color: #f45a40;font-size: 18px;font-weight: 600;">Prabhat Joshi</span> being painter is
                much, much more than a job or a dream to peruse. It has been
                ...
                invented and developed by him.<br> Perched in a city 6000 ft. above the sea level in the Shivalik
                mountain ranges of Mahahimalayas, he is trying to fulfill an almost mystical task of capturing the
                natural beauty of the region and then translating it into his imaginary paintings called miniature
                landscapes.
                Not only this many of his miniatures, reminding of ancient ruins or may be the ruins we all have deep
                within us, take you to a magical mystery tour in the world, in the past, in your own subconscious. That
                is probably why he has not given any name to them, you can name them what you like.
            </p>
            <div class="buy-now">
